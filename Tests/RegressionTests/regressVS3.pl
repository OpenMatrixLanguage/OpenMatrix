...
#my $oml = cwd() . '/../../../hw/bin/win64d';
my $oml;
#using release package my $oml = 'C:\Progra~1\stCompose\13.0.10\hwx\bin\win64';
...
print "Run stCompose regression test using stCompose.exe at path:\n";
system("where ".$oml);
print "\n";
system("pause");
