...
// Constructor
//------------------------------------------------------------------------------
hwChebyshev_I_s::hwChebyshev_I_s(int    order, 
    ...
    : m_pCheby_I_Proto (NULL)              
{
    ...
    if (!m_pCheby_I_Proto->Status().IsOk())
    {
...
// Destructor
//------------------------------------------------------------------------------
hwChebyshev_I_s::~hwChebyshev_I_s()
{
    if (m_pCheby_I_Proto)
    {
        delete m_pCheby_I_Proto;
        m_pCheby_I_Proto = nullptr;
    }
}
//------------------------------------------------------------------------------
// Compute location of the real pole
//------------------------------------------------------------------------------
void hwChebyshev_I_s::GetSPlaneInfo(double& poleReal) const
{
...
//------------------------------------------------------------------------------
void hwChebyshev_I_s::GetSPlaneInfo(int     i,
                                    double& poleReal,
...
//------------------------------------------------------------------------------
double hwChebyshev_I_s::GetRippleFactor() const
{
