...
// Constructor
//------------------------------------------------------------------------------
hwElliptic_s::hwElliptic_s(int    order, 
...
// Destructor
//------------------------------------------------------------------------------
hwElliptic_s::~hwElliptic_s()
{
}
//------------------------------------------------------------------------------
// Compute location of the real pole
//------------------------------------------------------------------------------
void hwElliptic_s::GetSPlaneInfo(double& poleReal) const
{
...
//------------------------------------------------------------------------------
void hwElliptic_s::GetSPlaneInfo(int     i, 
                                 double& poleReal, 
                                 double& poleMagSq,
...
//------------------------------------------------------------------------------
double hwElliptic_s::GetRippleFactor() const
{
