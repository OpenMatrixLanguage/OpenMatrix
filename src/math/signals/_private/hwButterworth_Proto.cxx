...
// Constructor
//------------------------------------------------------------------------------
hwButterworth_Proto::hwButterworth_Proto(int order)
...
// Destructor
//------------------------------------------------------------------------------
hwButterworth_Proto::~hwButterworth_Proto()
{
}
//------------------------------------------------------------------------------
// Compute location of the real pole
//------------------------------------------------------------------------------
void hwButterworth_Proto::GetSPlaneInfo(double& poleReal) const
{
    // real pole
    poleReal = -1.0;
}
...
//------------------------------------------------------------------------------
void hwButterworth_Proto::GetSPlaneInfo(int     i, 
                                        double& poleReal, 
