...
// Constructor
//------------------------------------------------------------------------------
hwChebyshev_I_Design::hwChebyshev_I_Design()
{
}
//------------------------------------------------------------------------------
// Destructor
...
//------------------------------------------------------------------------------
void hwChebyshev_I_Design::DesignPrototype(double  epsilon, 
                                           double  delta,
                                           double  omegaS2, 
                                           int&    order,
                                           double& omegaP1, 
                                           double& omegaP2)
{
    ...
    double orderFp = acosh(value) / acosh(omegaS2); // floating point filter order
    ...
    omegaP2 = omegaS2 / omegaSP; // hit stop band requirement
}
