...
*/
#ifndef _Signals_hwButterworth_s_h
#define _Signals_hwButterworth_s_h
...
//------------------------------------------------------------------------------
//!
//! \brief Butterworth analog filter class
//!
//------------------------------------------------------------------------------
class hwButterworth_s : public hwAnalogFilter
{
public:
    //!
    //! Constructor
    ...
    //! \param type
    //!
    hwButterworth_s(int    order, 
                    double lowCutoffFreq,
                    double highCutoffFreq);
    //!
    //! Destructor
    //!
    virtual ~hwButterworth_s();
...
#endif // _Signals_hwButterworth_s_h
