...
*/
#ifndef _Signals_Hanning_h
#define _Signals_Hanning_h
...
//!
//------------------------------------------------------------------------------
class hwHanning : public hwWindowFunc
{
public:
    //! 
    //! Constructor
    ...
    //!
    hwHanning(bool periodic);
    //! 
    //! Constructor
    //! \param numPoints Number of points
    //! \param periodic  True if periodic
    //!
    hwHanning(int  numPoints, 
              bool periodic);
    //!
    //! Destructor
    //!
