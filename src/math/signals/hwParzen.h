...
*/
#ifndef _Signals_Parzen_h
#define _Signals_Parzen_h
...
//!
//! \class hwParzen
//! \brief Parzen window class
//!
//------------------------------------------------------------------------------
class hwParzen : public hwWindowFunc
{
public:
    //!
    //! Constructor
    ...
    //!
    hwParzen(bool periodic);
    //!
    //! Constructor
    //! \param numPoints Number of points
    //! \param periodic True if periodic window type 
    //!
    hwParzen(int  numPoints, 
             bool periodic);
    //!
    //! Destructor
    //!
