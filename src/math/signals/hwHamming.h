...
*/
#ifndef _Signals_Hamming_h
#define _Signals_Hamming_h
...
//!
//------------------------------------------------------------------------------
class hwHamming : public hwWindowFunc
{
public:
    //! 
    //! Constructor
    ...
    //!
    hwHamming(bool periodic);
    //! 
    //! Constructor
    //! \param numPoints Number of points
    //! \param periodic  True if periodic
    //!
    hwHamming(int  numPoints, 
              bool periodic);
    //!
    //! Destructor
    //!
