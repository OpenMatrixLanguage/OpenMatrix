...
//------------------------------------------------------------------------------
//!
//! \class hwChebyshev_II_Proto
//! \brief Chebyshev II prototype low pass filter class. Generates s plane data
//! for a low pass Chebyshev II prototype filter that is transformed into 
//! digital and analog filters having the various passband types.
//!
//------------------------------------------------------------------------------
class hwChebyshev_II_Proto : public hwLowPass_Proto
{
public:
    //!
    //! Constructor
    ...
    //! \param stopEdgeDb
    //!
    hwChebyshev_II_Proto(int    order, 
                         double stopEdgeDb);
    //!
    //! Destructor
    //!
    virtual ~hwChebyshev_II_Proto();
...
#endif // _Signals_hwChebyshev_II_Proto_h
