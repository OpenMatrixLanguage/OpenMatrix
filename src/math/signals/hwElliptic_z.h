...
#ifndef _Signals_hwElliptic_z_h
#define _Signals_hwElliptic_z_h
...
//!
//! \class hwElliptic_z
//! \brief Elliptic digital filter class
//!
//------------------------------------------------------------------------------
class hwElliptic_z : public hwDigitalFilter
{
public:
    //!
    //! Constructor
