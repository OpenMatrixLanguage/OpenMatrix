...
*/
#ifndef _Signals_hwDigitalFilter_AP_h
#define _Signals_hwDigitalFilter_AP_h

#include "hwDigitalFilterGen_IIR.h"

//------------------------------------------------------------------------------
//!
//! \class hwDigitalFilterGen_AP
//! \brief Digital filter All Pole generator class, all Poles are in the S plane 
//! - no zeros
//!
//------------------------------------------------------------------------------
class hwDigitalFilterGen_AP : public hwDigitalFilterGen_IIR
{
public:
    //!
    ...
    //! \param digitalFilter
    //! 
    hwDigitalFilterGen_AP(const hwFilterSpecs& filterSpecs, 
                          hwDigitalFilter&     digitalFilter);
    //!
    //! Destructor
    //!
    virtual ~hwDigitalFilterGen_AP();
...
#endif // _Signals_hwDigitalFilter_AP_h
