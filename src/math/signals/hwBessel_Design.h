...
*/
#ifndef _Signals_hwBessel_Design_h
#define _Signals_hwBessel_Design_h

#include "hwFilterDesign.h"

//------------------------------------------------------------------------------
//!
//! \brief Bessel filter design class
//!
//------------------------------------------------------------------------------
class hwBessel_Design : public hwFilterDesign
{
public:
    //!
    //! Constructor
...
protected:
    ...
    //! \param omegaS
    //!
    void SolveProtoCutoff(double  epsilon, 
                          double  delta, 
                          int     order,
                          double& omegaC, 
                          double& omegaP, 
...
#endif // _Signals_hwBessel_Design_h
