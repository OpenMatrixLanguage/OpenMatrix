...
*/
#ifndef _Stats_hwNormal_h
#define _Stats_hwNormal_h
...
//!
//! \class hwNormal
//! \brief Standard normal distribution class
//!
//------------------------------------------------------------------------------
class hwNormal : public hwDistribution
{
public:
    //!
    //! Constructor
    //! \param pMTState
    //!
    hwNormal(hwMersenneTwisterState* pMTState = nullptr);
    //!
    //! Destructor
    //!
    virtual ~hwNormal();
...
private:
    bool       m_bExtraDeviate; //!< extra deviate existenace flag
    double     m_extraDeviate;  //!< extra deviate from pair
    hwUniform* m_pUniform;      //!< pointer to uniform distribution
};

#endif // _Stats_hwNormal_h
