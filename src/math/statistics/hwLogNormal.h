...
*/
#ifndef _Stats_hwLogNormal_h
#define _Stats_hwLogNormal_h
...
//!
//------------------------------------------------------------------------------
class hwLogNormal : public hwDistribution
{
public:
    //!
    //! Constructor
...
private:
    ...
    hwNormal* m_pNormDist; //!< pointer to standard normal distribution
};

#endif // _Stats_hwLogNormal_h
