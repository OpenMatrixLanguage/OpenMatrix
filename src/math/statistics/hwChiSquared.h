...
*/
#ifndef _Stats_hwChiSquared_h
#define _Stats_hwChiSquared_h
...
//!
//------------------------------------------------------------------------------
class hwChiSquared : public hwDistribution
{
public:
    //!
    //! Constructor
    ...
    //!
    double Mean() { return static_cast<double>(n); }
    //!
    //! Returns distribution variance
    //!
    double Variance() { return 2.0 * n; }
    //!
