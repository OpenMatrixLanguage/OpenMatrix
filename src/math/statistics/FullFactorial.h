...
*/
#ifndef _Stats_FullFactor_h
#define _Stats_FullFactor_h
...
//------------------------------------------------------------------------------
//!
//! \brief Full factorial function
//!
//------------------------------------------------------------------------------

//!
//! Construct a full factorial design matrix and return status
//! \param runs   Number of runs for each factor
//! \param matrix Full factorial design matrix
//!
STATISTICS_DECLS hwMathStatus FullFact(const hwMatrixI& runs, 
                                       hwMatrixI&       matrix);

#endif // _Stats_FullFactor_h
