...
#ifndef __EvaluatorDebug_h
#define __EvaluatorDebug_h
...
{
public:
	EvaluatorDebugInterface() {}

	virtual void PreFunctionCall(DebugStateInfo dsi) {}
	virtual void PreStatement(DebugStateInfo dsi) {}
	virtual void PreFunctionReturn(DebugStateInfo dsi) {}
};
