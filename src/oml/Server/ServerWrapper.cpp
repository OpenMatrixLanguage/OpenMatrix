...
//------------------------------------------------------------------------------
ServerWrapper::ServerWrapper(Interpreter* interp, OmlServer* server, SignalHandlerBase* handler)
...
//------------------------------------------------------------------------------
void ServerWrapper::ConnectOmlSignalHandler()
{
    if (_interp && _handler)
    {
        _handler->SetWrapper(this);
        _interp->SetSignalHandler(_handler);
    }
}
//------------------------------------------------------------------------------
